  ...
  return (
    ...
    >
      ...
      <div className="px-5 pt-12 pb-4">
        <Link href="/child/home" className="inline-block mb-3 text-xl">←</Link>
            ...
            {missions.filter((m) => !m.completed).map((mission) => (
              <div key={mission.id}>
                ...
                {mission.isMoodRating && expandedMoodId === mission.id && (
                  <div
                    className="mx-1 mt-1 rounded-2xl p-4 flex flex-col items-center gap-3"
                    style={{ background: "white", border: "1.5px solid hsl(44 100% 85%)", boxShadow: "0 2px 12px rgba(26,107,90,0.10)" }}
                  >
      ...
      {completedCount === totalCount && totalCount > 0 && (
        <div className="px-4 mt-2">
          <div className="rounded-2xl p-4 text-center" style={{ background: "#DCFCE7", border: "1.5px solid #BBF7D0" }}>
            <p className="text-lg font-bold mb-1" style={{ color: "#15803D" }}>🎉 모든 미션 완료!</p>
            <p className="text-sm" style={{ color: "#166534" }}>오늘도 정말 잘했어!</p>
          </div>
        </div>
      )}
