  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-sm flex flex-col gap-3">
        <Link
          href="/parent/home"
          className="flex items-center gap-4 bg-white rounded-2xl p-5 active:opacity-80 transition-opacity"
        ...
        <button
          ...
          className="flex items-center gap-4 bg-white rounded-2xl p-5 w-full text-left active:opacity-80 transition-opacity"
